...
public class Week02BooleanConditionalsLoopsLab {
	...
	public static void main(String[] args) {
		...
		if (age>=16) {
			...
			System.out.println("This is just a boolean expression");
		}
		else {
		...
		System.out.println("Your current member status is " + loyaltyMemberStatus + " and your discount is "
				+ String.format("%,.2f", loyaltyMemberDiscount));
		
		// I added the print line to make sure it worked, also used format so it wouldn't print 0.1 for SILVER
		...
		double billTotal = 864.99;
		double adjustedTotal = billTotal - (billTotal*loyaltyMemberDiscount);
		System.out.println("Your total is " + String.format("%, .2f", billTotal));
		
		System.out.println("Your adjusted total after your discount is " + String.format("%, .2f", adjustedTotal));
		
		if (adjustedTotal>500 && loyaltyMemberStatus == "SILVER") {
			loyaltyMemberStatus = "GOLD";
			System.out.println("Just upgraded your membershipt from SILVER to " +loyaltyMemberStatus);
		}
		else if (adjustedTotal>500 && loyaltyMemberStatus == "GOLD") {
			loyaltyMemberStatus = "PLATINUM";
			System.out.println("Just upgraded your membership from GOLD to " + loyaltyMemberStatus);
		}
		
		// Again added print statements to check if the code works, and formatted how the decimals are printed
		...
		String username = "Goppers101";
		String password = "1LoveTr3ats";
		
		if (username=="Goppers101" && password=="1LoveTr3ats") {
